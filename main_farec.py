...
image_path_to_compare = os.path.join(BASE_DIR, 'picture example/example_to_compare_true.jpg')
...
def compare_images(original, compare):
    ...
    print(compare_face)
    if compare_face[0]:
        assert compare_face[0] is not True
        ...
        for face_location in face_locations:
            ...
            print("Our four photo: {}, 2: {}, 3: {}, 4: {},".format(top, right, bottom, left))
...
# ______ test function whit asserts______
